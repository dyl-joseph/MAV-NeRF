...
logger = logging.getLogger("pixar_replay.core.dataset.replay_dataset")
sh = logging.StreamHandler()
logger.addHandler(sh)
logger.setLevel(logging.DEBUG)


DATASET_ROOT = r'C:\Users\dylan\replay_dataset\tests\data'
METADATA_FILE = os.path.join(r'C:\Users\dylan\replay_dataset\tests\data', "replay_dataset_100.sqlite")
SET_LIST_FILE = os.path.join(r'C:\Users\dylan\replay_dataset\tests\data', "set_lists_100.json")
...
class TestReplayDataset(unittest.TestCase):
    def test_basic(self, sequence="cat1_seq2", frame_number=4):
        ...
        self.assertEqual(item.sensor_name, "even_sensor")
    ...
    def test_pick_frames_sql_clause(self):
        dataset_no_empty_masks = ReplayDataset(
            sqlite_metadata_file=METADATA_FILE,
            remove_empty_masks=True,
            frame_data_builder_ReplayFrameDataBuilder_args=NO_BLOBS_KWARGS,
        )
    ...
    def test_category_to_sequence_names(self):
        ...
        cat_to_seqs_base = super(ReplayDataset, dataset).category_to_sequence_names()
    ...
    def test_meta_access(self):
        ...
        for idx in [10, ("cat0_seq2", 2)]:
            ...
            self.assertEqual(example_meta.sensor_name, example.sensor_name)
    ...
    def test_meta_access_no_blobs(self):
        dataset = ReplayDataset(
            ...
            subset_lists_file=SET_LIST_FILE,
            subsets=["train"],
            frame_data_builder_ReplayFrameDataBuilder_args={
                "dataset_root": ".",
